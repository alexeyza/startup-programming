...
- [Cloud computing services](https://docs.google.com/presentation/d/10YzdcKihpphwu9zDsIxBHP7ntKUPYePb2sj973sywUI) - [Code tutorials (of various platforms)](http://startupprogrammingdemo.appspot.com/) for the example shown in class can be found in the [tutorials section](tutorials).
